...
$sql = "UPDATE animals SET
    ...
    phase_family_title = :phase_family_title,
    phase_family_text = :phase_family_text,
    phase_baby_title = :phase_baby_title,
    phase_baby_text = :phase_baby_text,
    phase_leaving_title = :phase_leaving_title,
    phase_leaving_text = :phase_leaving_text,
    phase_independent_title = :phase_independent_title,
    phase_independent_text = :phase_independent_text,
    color = :color
WHERE id = :id;";
...
if ($stmt->rowCount() > 0) {
    echo json_encode((object)[
        "status" => 200,
        "success" => true,
        "message" => "The animal has been updated successfully."
    ]);
    ...
    echo json_encode((object)[
        "status" => 204,
        "success" => false,
        "message" => "Failed to update the animal."
    ]);
