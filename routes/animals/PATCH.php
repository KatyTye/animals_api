...
$animal = $_GET["animal"] ?? $search_able ?? 1;
...
$allowed = [
    "min_age", "max_age", "public", "type", "length_unit", "weight_unit",
    "length_min", "length_max", "weight_min", "weight_max", "color", "public",
	"name","science_name","image","phase_family_title","phase_family_text",
	"phase_baby_title","phase_baby_text","phase_leaving_title","phase_leaving_text",
	"phase_independent_title","phase_independent_text"
];
...
if ($stmt->rowCount() > 0) {
    echo json_encode((object)[
        "status" => 200,
        "success" => true,
        "message" => "The animal's ".$headers["field"]." has been updated successfully."
    ]);
    ...
    echo json_encode((object)[
        "status" => 204,
        "success" => false,
        "message" => "Failed to update the field ".$headers["field"]." for the animal."
    ]);
